...
|----------|---------|----------|--------------|
| [`CBPA2_HUMAN_Tsuboyama_2023_1O6X_example.ipynb`](examples/CBPA2_HUMAN_Tsuboyama_2023_1O6X_example.ipynb) | CUE domain of ubiquitin-binding protein A ([Tsuboyama et al. 2023](https://www.nature.com/articles/s41586-023-06328-6)) | 1,357 singles + 711 doubles | All current strategies with visualizations |
